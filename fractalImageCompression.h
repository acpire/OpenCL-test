...
class fractalImageCompression
{
	...
	void compress(cl_uint* errors, cl_uchar* image, cl_uint2* position_xy, cl_float* q, cl_uchar* typeFigure, size_t size_domain, size_t size_rank, size_t width, size_t height);
